...
<body>
	...
	<header class="container header_area">
		<div style="display: flex;  width:100vw ">
			...
			<h1 style="color: #fff;text-align:center;width:67vw;margin: left 250px">School Management System</h1>
			<div class="menu ">
				...
				<ul>
					...
					<?php if ($user->get_faculty_session()) { ?>
						...
						<li><a href="fct_single_profile.php"><i class="fa fa-user" aria-hidden="true"></i> <?php echo $fname;?></a></li>
