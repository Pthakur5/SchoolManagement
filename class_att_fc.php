...
<div class="all_student fix">
	...
	<form action="" method="post">
		...
		<span style="margin-left:360px;"><input style="text-align:right;background:#58A85D;border:none;color:#fff;padding:8px 100px; margin-left:220px" type="submit" name="submit" value="Submit" /></span>
