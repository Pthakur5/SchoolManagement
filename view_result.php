...
<div class="all_student fix">
		...
		function grade_point($gd){
			if($gd<40) return 0;
			elseif($gd>=40 && $gd<50) return 5;
			elseif($gd>=50 && $gd<60) return 6;
			elseif($gd>=60 && $gd<70) return 7;
			elseif($gd>=70 && $gd<80) return 8;
			elseif($gd>=80 && $gd<90) return 9;
			elseif($gd>=90 && $gd<=100) return 10;
		}
		?>
		...
		?>
			<tr>
				...
				<?php
					...
					else if($stat>=40 && $stat<50){
						echo "<span style='background:yellow'>Retake</span>";
					}
					else if($stat>=50 && $stat<60){
						echo "<span style='background:yellow'>Pass</span>";
					}
					else if($stat>=60 && $stat<70){
						echo "<span style='background:yellow'>Pass</span>";
					}else{
